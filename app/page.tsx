  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="bg-white border border-slate-100 rounded-xl h-80 animate-pulse"
              />
            ))}
          </div>
        ) : resumes.length > 0 ? (
              ...
              <div className="col-span-full">
                ...
                >
                  ...
                  <p className="text-slate-500 mb-8 max-w-xs text-center font-medium">
                    No analyses match your search. Try adjusting your search
                    terms.
                  </p>
                  <button
          ...
          >
            ...
            <p className="text-slate-500 mb-8 max-w-xs text-center font-medium">
              Upload your first resume to get tailored AI feedback and ATS
              scores.
            </p>
            <Link
              href="/upload"
      ...
      <footer className="py-8 text-center text-slate-400 text-xs font-semibold uppercase tracking-widest border-t border-slate-100">
        © 2026 ResumeAnalyzer • Powered by Google Gemini
      </footer>
    </div>
  );
};
